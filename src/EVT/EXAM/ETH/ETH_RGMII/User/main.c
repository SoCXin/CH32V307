 ...
 *@Note 
 ...
 注意：本例程在主频为144MHz下演示，使用RGMII。
 注意：RGMII需要125MHz时钟，由内部PLL产生或者由125_IN(PB1)引脚输入。本程序演示由外部输入125MHz.
*/
...
int main(void)
{
    ...
    printf("WCH Ethernet RGMII test program.Complair @ %s,%s.\n",__DATE__,__TIME__);
    printf("SystemClk:%d Hz.\n",RCC_ClocksStatus.SYSCLK_Frequency);

    /* Set PLL3 output as 62.5MHz, PLL3 output as 125MHz*/
    SET_MCO();
    /* TIM1 initialization */
    TIM1_Init();
    /* ETH initialization */
