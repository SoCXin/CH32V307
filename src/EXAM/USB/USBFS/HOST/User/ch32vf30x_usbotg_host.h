...
extern __attribute__ ((aligned(16))) UINT8 endpRXbuff[64+64]; //端点1数据收发缓冲区
extern __attribute__ ((aligned(16))) UINT8 endpTXbuff[64+64]; //端点3数据收发缓冲区
/*******************函数外扩*******************/
extern void  OTG_RCC_Init(void);
...
extern UINT8 USBHostTransact(UINT8 endp_pid, UINT8 tog, UINT32 timeout);
...
extern UINT8 USBOTG_HostEnum(void);
