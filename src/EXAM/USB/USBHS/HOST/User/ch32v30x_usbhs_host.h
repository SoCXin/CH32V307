...
#define USBHD_BASE_CTRL         (*((PUINT8V)(0x50000000)))  // USB base control
...
#define USBHD_UDEV_CTRL        (*((PUINT8V)(0x50000001)))  // USB device physical prot control
...
#define USBHD_UHOST_CTRL     (*((PUINT8V)(0x50000001)))      // USB host physical prot control
...
#define USBHD_INT_EN       (*((PUINT8V)(0x50000002)))  // USB interrupt enable
...
#define USBHD_DEV_ADDR       (*((PUINT8V)(0x50000003)))  // USB device address
#define     USBHD_UDA_GP_BIT       0x80      // general purpose bit
#define     USBHD_USB_ADDR_MASK       0x7F      // bit mask for USB device address

#define USBHD_MIS_ST       (*((PUINT8V)(0x50000005)))  // USB miscellaneous status
...
#define USBHD_INT_FG       (*((PUINT8V)(0x50000006)))  // USB interrupt flag
...
#define USBHD_INT_ST       (*((PUINT8V)(0x50000007)))  // USB interrupt status
...
#define R16_USB_RX_LEN       (*((PUINT16V)(0x50000008)))  // USB receiving length
#define USBHD_UEP4_1_MOD       (*((PUINT8V)(0x5000000c)))  // endpoint 4/1 mode
...
#define USBHD_UEP2_3_MOD       (*((PUINT8V)(0x5000000d)))  // endpoint 2/3 mode
...
//#define R8_UH_EP_MOD        USBHD_UEP2_3_MOD               //host endpoint mode
#define USBHD_UH_EP_MOD     USBHD_UEP2_3_MOD
...
#define USBHD_UEP5_6_MOD       (*((PUINT8V)(0x5000000e)))  // endpoint 5/6 mode
...
#define USBHD_UEP7_MOD         (*((PUINT8V)(0x5000000f)))  // endpoint 7 mode
...
#define USBHD_UEP0_DMA        (*((PUINT32V)(0x50000010))) // endpoint 0 DMA buffer address
#define USBHD_UEP1_DMA        (*((PUINT32V)(0x50000014))) // endpoint 1 DMA buffer address
#define USBHD_UEP2_DMA        (*((PUINT32V)(0x50000018))) // endpoint 2 DMA buffer address
#define USBHD_UH_RX_DMA       USBHD_UEP2_DMA                // host rx endpoint buffer high address
#define USBHD_UEP3_DMA        (*((PUINT32V)(0x5000001c))) // endpoint 3 DMA buffer address

#define USBHD_UEP4_DMA        (*((PUINT32V)(0x50000020))) // endpoint 4 DMA buffer address
#define USBHD_UEP5_DMA        (*((PUINT32V)(0x50000024))) // endpoint 5 DMA buffer address
#define USBHD_UEP6_DMA        (*((PUINT32V)(0x50000028))) // endpoint 6 DMA buffer address
#define USBHD_UEP7_DMA        (*((PUINT32V)(0x5000002c))) // endpoint 7 DMA buffer address

#define USBHD_UH_TX_DMA         USBHD_UEP3_DMA    // host tx endpoint buffer high address
#define USBHD_UEP0_T_LEN       (*((PUINT8V)(0x50000030)))  // endpoint 0 transmittal length
#define USBHD_UEP0_TX_CTRL     (*((PUINT8V)(0x50000032)))  // endpoint 0 control
#define USBHD_UEP0_RX_CTRL     (*((PUINT8V)(0x50000033)))  // endpoint 0 control
#define USBHD_UEP1_T_LEN       (*((PUINT8V)(0x50000034)))  // endpoint 1 transmittal length
#define USBHD_UEP1_TX_CTRL     (*((PUINT8V)(0x50000036)))  // endpoint 1 control
#define USBHD_UEP1_RX_CTRL     (*((PUINT8V)(0x50000037)))  // endpoint 1 control
...
//   10: NAK (busy)
//   11: STALL (error)
#define USBHD__UEP_T_RES1       0x02      // handshake response type high bit for USB endpoint X transmittal (IN)
#define USBHD__UEP_T_RES0       0x01      // handshake response type low bit for USB endpoint X transmittal (IN)
...
//   11: STALL (error)
              // host aux setup
#define USBHD_UH_SETUP      USBHD_UEP1_TX_CTRL
...
#define USBHD_UEP2_T_LEN       (*((PUINT8V)(0x50000038)))  // endpoint 2 transmittal length
#define USBHD_UEP2_TX_CTRL     (*((PUINT8V)(0x5000003a)))  // endpoint 2 tx control
#define USBHD_UEP2_RX_CTRL     (*((PUINT8V)(0x5000003b)))  // endpoint 2 rx control
              // host endpoint and PID
#define USBHD_UH_EP_PID     USBHD_UEP2_T_LEN
...
#define USBHD_UEP3_T_LEN       (*((PUINT16V)(0x5000003c))) // endpoint 3 transmittal length
#define USBHD_UEP3_TX_CTRL     (*((PUINT8V)(0x5000003e)))  // endpoint 3 tx control
#define USBHD_UEP3_RX_CTRL     (*((PUINT8V)(0x5000003f)))  // endpoint 3 rx control

#define USBHD_UH_TX_LEN     USBHD_UEP3_T_LEN
...
#define USBHD_UEP4_T_LEN       (*((PUINT8V)(0x50000040)))  // endpoint 4 transmittal length
#define USBHD_UEP4_TX_CTRL     (*((PUINT8V)(0x50000042)))  // endpoint 4 tx control
#define USBHD_UEP4_RX_CTRL     (*((PUINT8V)(0x50000043)))  // endpoint 4 rx control


#define USBHD_UEP5_T_LEN       (*((PUINT8V)(0x50000044)))  // endpoint 5 transmittal length
#define USBHD_UEP5_TX_CTRL     (*((PUINT8V)(0x50000046)))  // endpoint 5 tx control
#define USBHD_UEP5_RX_CTRL     (*((PUINT8V)(0x50000047)))  // endpoint 5 rx control

#define USBHD_UEP6_T_LEN       (*((PUINT8V)(0x50000048)))  // endpoint 6 transmittal length
#define USBHD_UEP6_TX_CTRL     (*((PUINT8V)(0x5000004a)))  // endpoint 6 tx control
#define USBHD_UEP6_RX_CTRL     (*((PUINT8V)(0x5000004b)))  // endpoint 6 rx control


#define USBHD_UEP7_T_LEN       (*((PUINT8V)(0x5000004c)))  // endpoint 7 transmittal length
#define USBHD_UEP7_TX_CTRL     (*((PUINT8V)(0x5000004e)))  // endpoint 7 tx control
#define USBHD_UEP7_RX_CTRL     (*((PUINT8V)(0x5000004f)))  // endpoint 7 rx control



#define  USB_OTG_CR           (*((PUINT32V)(0x50000054)))  // usb otg control
...
#define  USB_OTG_SR          (*((PUINT32V)(0x50000058)))  // usb otg status
...
#define ERR_AOA_PROTOCOL     0x41    
 /********************************************/
 // USB DEVICE
 #define USBHSENDP_RX_TOG_AUTO                (1<<29)
 #define USBHSENDP_TX_TOG_AUTO                (1<<21)

 #define USBHS_ENDP1_TX_ISO        (1<<1)
 #define USBHS_ENDP2_TX_ISO        (1<<2)
 #define USBHS_ENDP3_TX_ISO        (1<<3)
 #define USBHS_ENDP4_TX_ISO        (1<<4)
 #define USBHS_ENDP5_TX_ISO        (1<<5)
 #define USBHS_ENDP6_TX_ISO        (1<<6)
 #define USBHS_ENDP7_TX_ISO        (1<<7)
 #define USBHS_ENDP8_TX_ISO        (1<<8)
 #define USBHS_ENDP9_TX_ISO        (1<<9)
 #define USBHS_ENDP10_TX_ISO       (1<<10)
 #define USBHS_ENDP11_TX_ISO       (1<<11)
 #define USBHS_ENDP12_TX_ISO       (1<<12)
 #define USBHS_ENDP13_TX_ISO       (1<<13)
 #define USBHS_ENDP14_TX_ISO       (1<<14)
 #define USBHS_ENDP15_TX_ISO       (1<<15)

 #define USBHS_ENDP1_RX_ISO        (1<<(16+1))
 #define USBHS_ENDP2_RX_ISO        (1<<(16+2))
 #define USBHS_ENDP3_RX_ISO        (1<<(16+3))
 #define USBHS_ENDP4_RX_ISO        (1<<(16+4))
 #define USBHS_ENDP5_RX_ISO        (1<<(16+5))
 #define USBHS_ENDP6_RX_ISO        (1<<(16+6))
 #define USBHS_ENDP7_RX_ISO        (1<<(16+7))
 #define USBHS_ENDP8_RX_ISO        (1<<(16+8))
 #define USBHS_ENDP9_RX_ISO        (1<<(16+9))
 #define USBHS_ENDP10_RX_ISO       (1<<(16+10))
 #define USBHS_ENDP11_RX_ISO       (1<<(16+11))
 #define USBHS_ENDP12_RX_ISO       (1<<(16+12))
 #define USBHS_ENDP13_RX_ISO       (1<<(16+13))
 #define USBHS_ENDP14_RX_ISO       (1<<(16+14))
 #define USBHS_ENDP15_RX_ISO       (1<<(16+15))
 // USB CONTROL
 #define DMA_EN                  (1<<0)
...
//USB STATUS
 // INT_FLAG
#define USBHS_TOGGLE_OK          (1<<30)
#define USBHS_HOST_RES           (0xf<<24)
...
#define USBHS_SOF_PRES           (1<<15)
#define USBHS_SOF_ACT            (1<<14)
#define USBHS_SIE_FREE           (1<<13)
#define USBHS_FIFO_RDY           (1<<12)
#define USBHS_BUS_RESET          (1<<11)
#define USBHS_SUSPEND            (1<<10)
#define USBHS_ATTCH              (1<<9)
#define USBHS_SPLIT_CAN          (1<<8)
#define USBSPEED_MASK            (0x03)
 ...
 #define REMOTE_WAKE         (UINT32)(1<<11)
 #define SUSPENDM            (UINT32)(1<<12)
 #define LINK_READY          (UINT32)(1<<14)
 #define SEND_SOF_EN         (UINT32)(1<<15)
 // INT_EN
 #define USBHS__DETECT_EN      (1<<16)
 ...
 #define EP_T_RES_NO         (1<<18)
 #define EP_T_TOG_1          (1<<19)
 #define EP_T_TOG_2          (2<<19)
 #define EP_T_TOG_3          (3<<19)
 #define EP_T_TOG_AUTO       (1<<21)
 ...
 #define EP_R_RES_NO         (1<<26)
 #define EP_R_TOG_1          (1<<27)
 #define EP_R_TOG_2          (2<<27)
 #define EP_R_TOG_3          (3<<27)
 #define EP_R_TOG_AUTO       (1<<29)
 //INT STATUS

 //
 #define USB_NORES_TOUT       (0)
 #define TRANS_SUCCESS        (0x00)
 #define TRANS_ERR            (0x20)
 #define DEV_RES_STALL        (0xFF)
 #define USBHS_TOGGLE_ERR     (0xFF00)
 #define USBHS_HARDTIMEOUT    (0xFFF0)
 #define USBHS_TIMEOUT        (0xFFFF)
 #define TIMEOUT_COUNT        (1000000000)
...
#define USBHS_MAX_PACK_SIZE     512
 typedef struct  USB_STATUS
 {
     ...
     struct
     {
         ...
         UINT32  NumOfSec;               // 总扇区数
         UINT16  SecSize;                // 单扇区大小
         UINT8   MaxLun;                 // 最大逻辑单元号
     }DEVENDP;
